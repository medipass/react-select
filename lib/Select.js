...
var Select = function (_React$Component) {
	...
	function Select(props) {
		...
		_this.value = _react2.default.createRef();
		_this.name = _react2.default.createRef();
		_this.menuContainer = _react2.default.createRef();
	...
	_createClass(Select, [{
		...
		value: function componentDidUpdate(prevProps, prevState) {
			...
			if (this.menu && this.menu.current && this.focused && this.state.isOpen && !this.hasScrolledToOption) {
				...
				var menuNode = (0, _reactDom.findDOMNode)(this.menu.current);
			...
			if (this._scrollToFocusedOptionOnUpdate && this.focused && this.menu && this.menu.current) {
				...
				var menuDOM = (0, _reactDom.findDOMNode)(this.menu.current);
