(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react-input-autosize'), require('classnames'), require('prop-types'), require('react'), require('react-dom'), require('debounce-fn')) :
	typeof define === 'function' && define.amd ? define(['react-input-autosize', 'classnames', 'prop-types', 'react', 'react-dom', 'debounce-fn'], factory) :
	(global.Select = factory(global.AutosizeInput,global.classNames,global.PropTypes,global.React,global.ReactDOM,global.debounce));
}(this, (function (AutosizeInput,classNames,PropTypes,React,reactDom,debounce) { 'use strict';
...
var Async = function (_Component) {
	...
	function Async(props, context) {
		...
		_this.loadOptionsDebounced = debounce(_this.loadOptions, { wait: 500 });
		return _this;
	}
